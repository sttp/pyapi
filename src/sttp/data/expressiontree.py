...
class ExpressionTree:
    ...
    def __init__(self):
        ...
        self._currentrow: DataRow | None = None
        ...
        self.root: Expression | None = None
        """
    ...
    def select(self, table: DataTable) -> Tuple[List[DataRow], Exception | None]:
        """
        ...
        def predicate(result_expression: ValueExpression) -> Tuple[bool, Exception | None]:
    ...
    def selectwhere(self, table: DataTable, predicate: Callable[[ValueExpression], Tuple[bool, Exception | None]], applylimit: bool, applysort: bool) -> Tuple[List[DataRow], Exception | None]:
        """
    ...
    def evaluate(self, row: DataRow | None = None) -> Tuple[ValueExpression | None, Exception | None]:
        """
    ...
    def _evaluate(self, expression: Expression | ValueExpression | None, target_valuetype: ExpressionValueType = ExpressionValueType.BOOLEAN) -> Tuple[ValueExpression | None, Exception | None]:
    ...
    def _evaluate_unary(self, unary_expression: UnaryExpression) -> Tuple[ValueExpression | None, Exception | None]:
    ...
    def _evaluate_column(self, column_expression: ColumnExpression) -> Tuple[ValueExpression | None, Exception | None]:  # sourcery skip
    ...
    def _evaluate_in_list(self, inlist_expression: InListExpression) -> Tuple[ValueExpression | None, Exception | None]:
    ...
    def _evaluate_function(self, function_expression: FunctionExpression) -> Tuple[ValueExpression | None, Exception | None]:
    ...
    def _evaluate_abs(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) != 1:
    ...
    def _evaluate_ceiling(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) != 1:
    ...
    def _evaluate_coalesce(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) < 2:
    ...
    def _evaluate_convert(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) != 2:
    ...
    def _evaluate_contains(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
    ...
    def _evaluate_dateadd(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) != 3:
    ...
    def _evaluate_datediff(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) != 3:
    ...
    def _evaluate_datepart(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) != 2:
    ...
    def _evaluate_endswith(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) < 2 or len(arguments) > 3:
    ...
    def _evaluate_floor(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) != 1:
    ...
    def _evaluate_iif(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) != 3:
    ...
    def _evaluate_indexof(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) < 2 or len(arguments) > 3:
    ...
    def _evaluate_is_date(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) != 1:
    ...
    def _evaluate_is_integer(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) != 1:
    ...
    def _evaluate_is_guid(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) != 1:
    ...
    def _evaluate_is_null(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) != 2:
    ...
    def _evaluate_is_numeric(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) != 1:
    ...
    def _evaluate_lastindexof(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) < 2 or len(arguments) > 3:
    ...
    def _evaluate_len(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) != 1:
    ...
    def _evaluate_lower(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) != 1:
    ...
    def _evaluate_maxof(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) < 2:
            return None, ValueError(f"\"MaxOf\" function expects at least 2 arguments, received {len(arguments)}")

        return self._maxof(arguments)

    def _evaluate_minof(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) < 2:
            return None, ValueError(f"\"MinOf\" function expects at least 2 arguments, received {len(arguments)}")

        return self._minof(arguments)

    def _evaluate_nthindexof(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
    ...
    def _evaluate_now(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if arguments:
            return None, ValueError(f"\"Now\" function expects 0 arguments, received {len(arguments)}")

        return self._now()

    def _evaluate_power(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) != 2:
    ...
    def _evaluate_regexmatch(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) != 2:
    ...
    def _evaluate_regexval(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) != 2:
    ...
    def _evaluate_replace(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) < 3 or len(arguments) > 4:
    ...
    def _evaluate_reverse(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) != 1:
    ...
    def _evaluate_round(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) != 1:
    ...
    def _evaluate_split(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) < 3 or len(arguments) > 4:
    ...
    def _evaluate_sqrt(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) != 1:
    ...
    def _evaluate_startswith(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) < 2 or len(arguments) > 3:
    ...
    def _evaluate_strcount(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) < 2 or len(arguments) > 3:
    ...
    def _evaluate_strcmp(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) < 2 or len(arguments) > 3:
    ...
    def _evaluate_substr(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) < 2 or len(arguments) > 3:
    ...
    def _evaluate_trim(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) != 1:
    ...
    def _evaluate_trimleft(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) != 1:
    ...
    def _evaluate_trimright(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) != 1:
    ...
    def _evaluate_upper(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if len(arguments) != 1:
    ...
    def _evaluate_utcnow(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        if arguments:
            return None, ValueError(f"\"UtcNow\" function expects 0 arguments, received {len(arguments)}")

        return self._utcnow()

    def _evaluate_operator(self, operator_expression: OperatorExpression) -> Tuple[ValueExpression | None, Exception | None]:
    ...
    def _abs(self, sourcevalue: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
    ...
    def _ceiling(self, sourcevalue: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        sourcevaluetype = sourcevalue.valuetype
    ...
    def _coalesce(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        testvalue, err = self._evaluate(arguments[0])
    ...
    def _convert(self, sourcevalue: ValueExpression, targettype: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
    ...
    def _contains(self, sourcevalue: ValueExpression, testvalue: ValueExpression, ignorecase: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
    ...
    def _dateadd(self, sourcevalue: ValueExpression, addvalue: ValueExpression, intervaltype: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
    ...
    def _datediff(self, leftvalue: ValueExpression, rightvalue: ValueExpression, intervaltype: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        # sourcery skip
    ...
    def _datepart(self, sourcevalue: ValueExpression, intervaltype: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        if sourcevalue.valuetype not in [ExpressionValueType.DATETIME, ExpressionValueType.STRING]:
    ...
    def _endswith(self, sourcevalue: ValueExpression, testvalue: ValueExpression, ignorecase: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        if sourcevalue.valuetype != ExpressionValueType.STRING:
    ...
    def _floor(self, sourcevalue: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        sourcevaluetype = sourcevalue.valuetype
    ...
    def _iif(self, testvalue: ValueExpression, truevalue: Expression, falsevalue: Expression) -> Tuple[ValueExpression | None, Exception | None]:  # sourcery skip
    ...
    def _indexof(self, sourcevalue: ValueExpression, testvalue: ValueExpression, ignorecase: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        if sourcevalue.valuetype != ExpressionValueType.STRING:
    ...
    def _is_date(self, sourcevalue: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        if sourcevalue.is_null():
            return FALSEVALUE, None
    ...
    def _is_integer(self, sourcevalue: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        if sourcevalue.is_null():
            return FALSEVALUE, None
    ...
    def _is_guid(self, sourcevalue: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        if sourcevalue.is_null():
            return FALSEVALUE, None
    ...
    def _is_null(self, testvalue: ValueExpression, defaultvalue: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
    ...
    def _is_numeric(self, testvalue: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        if testvalue.is_null():
            return FALSEVALUE, None
    ...
    def _lastindexof(self, sourcevalue: ValueExpression, testvalue: ValueExpression, ignorecase: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        if sourcevalue.valuetype != ExpressionValueType.STRING:
    ...
    def _len(self, sourcevalue: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        if sourcevalue.valuetype != ExpressionValueType.STRING:
    ...
    def _lower(self, sourcevalue: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        if sourcevalue.valuetype != ExpressionValueType.STRING:
    ...
    def _maxof(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        testvalue, err = self._evaluate(arguments[0])
    ...
    def _minof(self, arguments: List[Expression]) -> Tuple[ValueExpression | None, Exception | None]:
        testvalue, err = self._evaluate(arguments[0])
    ...
    def _now(self) -> Tuple[ValueExpression | None, Exception | None]:
        return ValueExpression(ExpressionValueType.DATETIME, datetime.now()), None

    def _nthindexof(self, sourcevalue: ValueExpression, testvalue: ValueExpression, indexvalue: ValueExpression, ignorecase: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        if sourcevalue.valuetype != ExpressionValueType.STRING:
        ...
        return ValueExpression(ExpressionValueType.INT32, _find_nthindex(source, test, indexvalue.integervalue(-1))), None

    def _power(self, sourcevalue: ValueExpression, exponentvalue: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
    ...
    def _regexmatch(self, regexvalue: ValueExpression, testvalue: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        return self._evaluateregex("RegExMatch", regexvalue, testvalue, False)

    def _regexval(self, regexvalue: ValueExpression, testvalue: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        return self._evaluateregex("RegExVal", regexvalue, testvalue, True)

    def _evaluateregex(self, functionname: str, regexvalue: ValueExpression, testvalue: ValueExpression, return_matchedvalue: bool) -> Tuple[ValueExpression | None, Exception | None]:
    ...
    def _replace(self, sourcevalue: ValueExpression, testvalue: ValueExpression, replacevalue: ValueExpression, ignorecase: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        if sourcevalue.valuetype != ExpressionValueType.STRING:
    ...
    def _reverse(self, sourcevalue: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        if sourcevalue.valuetype != ExpressionValueType.STRING:
    ...
    def _round(self, sourcevalue: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        sourcevaluetype = sourcevalue.valuetype
    ...
    def _split(self, sourcevalue: ValueExpression, delimitervalue: ValueExpression, indexvalue: ValueExpression, ignorecase: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        if sourcevalue.valuetype != ExpressionValueType.STRING:
        ...
        sourcestr = sourcevalue._stringvalue()
        index = indexvalue._int32value()

        if ignorecase._booleanvalue():
            start, stop, success = _split_nthindex(sourcestr.upper(), delimitervalue._stringvalue().upper(), index)
        else:
            start, stop, success = _split_nthindex(sourcestr, delimitervalue._stringvalue(), index)

        return (ValueExpression(ExpressionValueType.STRING, sourcestr[start:stop]), None) if success else (EMPTYSTRINGVALUE, None)

    def _sqrt(self, sourcevalue: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        sourcevaluetype = sourcevalue.valuetype
    ...
    def _startswith(self, sourcevalue: ValueExpression, testvalue: ValueExpression, ignorecase: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        if sourcevalue.valuetype != ExpressionValueType.STRING:
    ...
    def _strcount(self, sourcevalue: ValueExpression, testvalue: ValueExpression, ignorecase: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        if sourcevalue.valuetype != ExpressionValueType.STRING:
    ...
    def _strcmp(self, leftvalue: ValueExpression, rightvalue: ValueExpression, ignorecase: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
    ...
    def _substr(self, sourcevalue: ValueExpression, indexvalue: ValueExpression, lengthvalue: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        if sourcevalue.valuetype != ExpressionValueType.STRING:
    ...
    def _trim(self, sourcevalue: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        if sourcevalue.valuetype != ExpressionValueType.STRING:
    ...
    def _trimleft(self, sourcevalue: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        if sourcevalue.valuetype != ExpressionValueType.STRING:
    ...
    def _trimright(self, sourcevalue: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        if sourcevalue.valuetype != ExpressionValueType.STRING:
    ...
    def _upper(self, sourcevalue: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        if sourcevalue.valuetype != ExpressionValueType.STRING:
    ...
    def _utcnow(self) -> Tuple[ValueExpression | None, Exception | None]:
    ...
    def _convert_operands(self, leftvalue: ValueExpression, rightvalue: ValueExpression, valuetype: ExpressionValueType) -> Tuple[ValueExpression | None, ValueExpression | None, Exception | None]:
        # sourcery skip
    ...
    def _multiply_op(self, leftvalue: ValueExpression, rightvalue: ValueExpression, valuetype: ExpressionValueType) -> Tuple[ValueExpression | None, Exception | None]:
    ...
    def _divide_op(self, leftvalue: ValueExpression, rightvalue: ValueExpression, valuetype: ExpressionValueType) -> Tuple[ValueExpression | None, Exception | None]:
        # If left or right value is Null, result is Null
        if leftvalue.is_null() or rightvalue.is_null():
            return ValueExpression.nullvalue(valuetype), None
    ...
    def _modulus_op(self, leftvalue: ValueExpression, rightvalue: ValueExpression, valuetype: ExpressionValueType) -> Tuple[ValueExpression | None, Exception | None]:
        # If left or right value is Null, result is Null
        if leftvalue.is_null() or rightvalue.is_null():
            return ValueExpression.nullvalue(valuetype), None
    ...
    def _add_op(self, leftvalue: ValueExpression, rightvalue: ValueExpression, valuetype: ExpressionValueType) -> Tuple[ValueExpression | None, Exception | None]:
        # If left or right value is Null, result is Null
        if leftvalue.is_null() or rightvalue.is_null():
            return ValueExpression.nullvalue(valuetype), None
    ...
    def _subtract_op(self, leftvalue: ValueExpression, rightvalue: ValueExpression, valuetype: ExpressionValueType) -> Tuple[ValueExpression | None, Exception | None]:
        # If left or right value is Null, result is Null
        if leftvalue.is_null() or rightvalue.is_null():
            return ValueExpression.nullvalue(valuetype), None
    ...
    def _bitshiftleft_op(self, leftvalue: ValueExpression, rightvalue: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
    ...
    def _bitshiftright_op(self, leftvalue: ValueExpression, rightvalue: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        # If left is Null, result is Null
        if leftvalue.is_null():
            return leftvalue, None
    ...
    def _bitwiseand_op(self, leftvalue: ValueExpression, rightvalue: ValueExpression, valuetype: ExpressionValueType) -> Tuple[ValueExpression | None, Exception | None]:
        # If left or right value is Null, result is Null
        if leftvalue.is_null() or rightvalue.is_null():
            return ValueExpression.nullvalue(valuetype), None
    ...
    def _bitwiseor_op(self, leftvalue: ValueExpression, rightvalue: ValueExpression, valuetype: ExpressionValueType) -> Tuple[ValueExpression | None, Exception | None]:
        # If left or right value is Null, result is Null
        if leftvalue.is_null() or rightvalue.is_null():
            return ValueExpression.nullvalue(valuetype), None
    ...
    def _bitwisexor_op(self, leftvalue: ValueExpression, rightvalue: ValueExpression, valuetype: ExpressionValueType) -> Tuple[ValueExpression | None, Exception | None]:
        # If left or right value is Null, result is Null
        if leftvalue.is_null() or rightvalue.is_null():
            return ValueExpression.nullvalue(valuetype), None
    ...
    def _lessthan_op(self, leftvalue: ValueExpression, rightvalue: ValueExpression, valuetype: ExpressionValueType) -> Tuple[ValueExpression | None, Exception | None]:
        # If left or right value is Null, result is Null
        if leftvalue.is_null() or rightvalue.is_null():
    ...
    def _lessthanorequal_op(self, leftvalue: ValueExpression, rightvalue: ValueExpression, valuetype: ExpressionValueType) -> Tuple[ValueExpression | None, Exception | None]:
        # If left or right value is Null, result is Null
        if leftvalue.is_null() or rightvalue.is_null():
            return ValueExpression.nullvalue(ExpressionValueType.BOOLEAN), None
    ...
    def _greaterthan_op(self, leftvalue: ValueExpression, rightvalue: ValueExpression, valuetype: ExpressionValueType) -> Tuple[ValueExpression | None, Exception | None]:
        # If left or right value is Null, result is Null
        if leftvalue.is_null() or rightvalue.is_null():
            return ValueExpression.nullvalue(ExpressionValueType.BOOLEAN), None
    ...
    def _greaterthanorequal_op(self, leftvalue: ValueExpression, rightvalue: ValueExpression, valuetype: ExpressionValueType) -> Tuple[ValueExpression | None, Exception | None]:
        # If left or right value is Null, result is Null
        if leftvalue.is_null() or rightvalue.is_null():
            return ValueExpression.nullvalue(ExpressionValueType.BOOLEAN), None
    ...
    def _equal_op(self, leftvalue: ValueExpression, rightvalue: ValueExpression, valuetype: ExpressionValueType, exactmatch: bool) -> Tuple[ValueExpression | None, Exception | None]:
        # If left or right value is Null, result is Null
        if leftvalue.is_null() or rightvalue.is_null():
            return ValueExpression.nullvalue(ExpressionValueType.BOOLEAN), None
    ...
    def _notequal_op(self, leftvalue: ValueExpression, rightvalue: ValueExpression, valuetype: ExpressionValueType, exactmatch: bool) -> Tuple[ValueExpression | None, Exception | None]:
        # If left or right value is Null, result is Null
        if leftvalue.is_null() or rightvalue.is_null():
            return ValueExpression.nullvalue(ExpressionValueType.BOOLEAN), None
    ...
    def _isnull_op(self, value: ValueExpression) -> ValueExpression | None:
        return ValueExpression(ExpressionValueType.BOOLEAN, value.is_null())

    def _isnotnull_op(self, value: ValueExpression) -> ValueExpression | None:
        return ValueExpression(ExpressionValueType.BOOLEAN, not value.is_null())

    def _like_op(self, leftvalue: ValueExpression, rightvalue: ValueExpression, exactmatch: bool) -> Tuple[ValueExpression | None, Exception | None]:
        # sourcery skip
    ...
    def _notlike_op(self, leftvalue: ValueExpression, rightvalue: ValueExpression, exactmatch: bool) -> Tuple[ValueExpression | None, Exception | None]:
        # If left is Null, result is Null
        if leftvalue.is_null():
            return NULLBOOLVALUE, None

        likeresult, err = self._like_op(leftvalue, rightvalue, exactmatch)
    ...
    def _and_op(self, leftvalue: ValueExpression, rightvalue: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        # If left or right value is Null, result is Null
        if leftvalue.is_null() or rightvalue.is_null():
            return NULLBOOLVALUE, None
    ...
    def _or_op(self, leftvalue: ValueExpression, rightvalue: ValueExpression) -> Tuple[ValueExpression | None, Exception | None]:
        # If left or right value is Null, result is Null
        if leftvalue.is_null() or rightvalue.is_null():
            return NULLBOOLVALUE, None
